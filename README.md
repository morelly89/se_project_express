...
- **Node.js** and **Express.js** — for server functionality and routing
- **MongoDB** — as the database
- **Mongoose** — for defining models and schemas
- **Controllers** — to separate route logic for cleaner code
